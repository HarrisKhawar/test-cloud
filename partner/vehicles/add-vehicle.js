...
const add_vehicle = async (request, response) => {
  try {
    ...
    await sendSlackNotification(
      `Partner ${partner.name} added a ${vehicle.make} ${vehicle.model} ${vehicle.year} - ${vehicle.vin}`
    );

    // Log Success
    logSuccess("add_vehicle", "Successfully added vehicle to partner.");
